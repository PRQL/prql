...
We released [0.10.0](https://github.com/PRQL/prql/releases/tag/0.10.0) in October.
It contains lots of small improvements, including support for new types of literal notation, support for `read_*` functions in more dialects, playground improvements, and a better Lezer grammar (which we're planning on using for a Jupyter extension).
Here's our current
