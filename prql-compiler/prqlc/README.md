...
allowing a PRQL query to be written interactively. In this mode, after you write
...
Just like when using it as a filter, you can pass the SQL string output to the
