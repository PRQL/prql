...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `json` grammar compiled for Highlight.js 11.7.0 */
...
aliases:["yml"],contains:b}}})();hljs.registerLanguage("yaml",e)})();/*! `ini` grammar compiled for Highlight.js 11.7.0 */
