...
Last week saw the 0.6 release of [PRQL](https://prql-lang.org) which brought with it
...
[PRQL Playground](https://prql-lang.org/playground), the result set you get (in the
"output.arrow" tab) is:
