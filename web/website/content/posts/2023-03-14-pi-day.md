...
[f-strings](https://prql-lang.org/book/syntax/f-strings.html), as well as not so
modern features such as
[functions](https://prql-lang.org/book/declarations/functions.html).
...
[PRQL book](https://prql-lang.org/book/stdlib/loop.html) is:
...
[s-string](https://prql-lang.org/book/syntax/s-strings.html) (s for SQL) and
allows us to include raw SQL inside our PRQL queries. We use this to include
features from DuckDB that haven't made it into PRQL yet, such as the Pythonesque
